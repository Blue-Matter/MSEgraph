...
HistList <- list(Base_Case=Hist1, Lower_M=Hist2, Higher_M=Hist1, Lower_h=Hist2)
MSEList <- list(Base_Case=MSE1, Lower_M=MSE2, Higher_M=MSE1, Lower_h=MSE2)

usethis::use_data(Hist1)
usethis::use_data(Hist2)
usethis::use_data(Hist3)
usethis::use_data(Hist4)

usethis::use_data(MSE1)
usethis::use_data(MSE2)
usethis::use_data(MSE3)
usethis::use_data(MSE4)

usethis::use_data(HistList)
usethis::use_data(MSEList)
